...
# -------------------------------
# Inject Background Images via Custom CSS
# -------------------------------
st.markdown(
    f"""
    <style>
    .stApp {{
        background-image: url("https://raw.githubusercontent.com/Ayo-tech-ai/DeeptechShowcase/refs/heads/main/main_background.jpeg");
        background-size: cover;
        background-attachment: fixed;
        background-repeat: no-repeat;
    }}
    section[data-testid="stSidebar"] > div:first-child {{
        background-image: url("https://raw.githubusercontent.com/Ayo-tech-ai/DeeptechShowcase/refs/heads/main/sidebar_background.jpeg");
        background-size: cover;
        background-repeat: no-repeat;
